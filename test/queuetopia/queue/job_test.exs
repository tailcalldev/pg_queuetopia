defmodule PgQueuetopia.Queue.JobTest do
  ...
  describe "create_changeset/2" do
    ...
    test "timing params default values" do
      params = params_for(:job, timeout: nil, max_backoff: nil, max_attempts: nil)
    ...
    test "when timing params are lesser than or equal to 0 are not valid, return a invalid changeset" do
      params = params_for(:job, timeout: -1, max_backoff: -1, max_attempts: -1)
    ...
    test "when timing params are not valid, return a invalid changeset" do
      params = params_for(:job, timeout: 0.4, max_backoff: 0.4, max_attempts: 0.4)
